...
\item \href{https://github.com/PSoni8/Bookcentre}{\textbf{Book Centre}}
        \begin{itemize}
           \item An \textbf{E-commerce platform} for retailers and customers to \textbf{sell and buy books} respectively. 
           ...
           \item \textbf{Role based access for users \& admins}, \textbf{email alert}, \textbf{Cart} and \textbf{Online Payment}.
           \item Only admins can \textbf{create, update, delete} products and categories.
           \item Users can \textbf{Search} products by name or by category, \textbf{Sort} products by sell, by arrival, by category or by price range.
        \end{itemize}
