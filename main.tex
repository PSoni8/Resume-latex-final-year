...
\hline
\centering{2018 - 2022} & \centering{B.Tech in Electronics \& Communication Engineering} & \centering{MN National Institute of Technology Allahabad, India} & 8.49/10\\
\hline
...
\href{https://www.ken42.com/}{\textbf{Ken42 EdTech}} (\textbf{Product Management Intern,Startup}) \hfill\hfill(\textit{Jan,2022-Present})
    \begin{itemize}
       ...
       \item Worked on \textbf{Product Requirement Document} of \textbf{Human Resource Management Software (HRMS)} Module. Designed workflow of HRMS with persona of Candidate, Hiring Manager, HR \& Interviewer.
       \item Worked on \textbf{Product Requirement Document} of \textbf{Procurement of educational Institution}.
    \end{itemize}
\vspace{3pt}
