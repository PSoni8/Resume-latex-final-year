...
\vspace{-1pt}
C, C++, Data Structure, Algorithm, HTML, CSS, Bootstrap, JavaScript, ReactJs, NodeJs, MySQL, MongoDB, Machine Learning, Git, Postman
\vspace{-7pt}
%experience
{\large \textbf{\begin{tcolorbox}\textsc{Internships}\end{tcolorbox}}}
\vspace{-2pt}
\href{https://www.linkedin.com/company/fifo-solutions/}{\textbf{Fifo Solutions}}\hfill\hfill(\textit{April,2021-Present})\\
\textbf{Web Development Intern}\hfill\hfill\textit{\textbf{Startup}, Andhra Pradesh, India}
    ...
    \end{itemize}
\vspace{3pt}
\href{http://www.siemens.com/}{\textbf{Siemens India}}\hfill\hfill(\textit{June,2021-Present})\\
\textbf{Summer Intern,Group of 4}\hfill\hfill\textit{Goa, India}
     ...
     \end{itemize}
\vspace{3pt}
\href{http://www.siemens.com/}{\textbf{Siemens India}}\hfill\hfill(\textit{June,2020-Sep,2020})\\
...
\vspace{-2pt}
\href{https://github.com/PSoni8/Bookcentre}{\textbf{Book Centre}}
        \begin{itemize}
        ...
        \end{itemize}
\vspace{3pt}
\href{https://github.com/PSoni8/Image-Caption-Generator}{\textbf{Image Caption Generator}}
         \begin{itemize}
