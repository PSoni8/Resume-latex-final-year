...
\textbf{Summer Project Intern,Group of 7}\hfill\hfill(\textit{June,2020-Sep,2020})
      \begin{itemize}
          ...
          \item We built \textbf{automated model} using Sensors, Arduino, \textbf{website} for Online Appointment using \textbf{HTML, CSS, Javascript, MySQL, PHP} \& \textbf{OCR} for Offline Registration using \textbf{Python, OpenCV}.
      \end{itemize}
\vspace{1mm}
%Projects
