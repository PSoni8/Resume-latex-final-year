...
\item \href{https://github.com/PSoni8/Bookcentre}{\textbf{Book Centre}}
        \begin{itemize}
           ...
           \item Only admin can \textbf{create, update, delete} products and categories.Users can \textbf{Search} and \textbf{Sort} products by sell, by arrival or by category.
