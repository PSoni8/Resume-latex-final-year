...
\vspace{-1pt}
\href{https://in.micron.com/}{\textbf{Micron Technology}} (\textbf{Associate Engineer, ESSD Firmware}) \hfill\hfill(\textit{July,2022-Present})
    \begin{itemize}
       \item Developing \textbf{firmware in C/C++} of High Capacity NVMe (Gen-4, ZNS - Based ) ESSD.
       ...
       \item \textbf{Tech Stack}: C, C++, Python, Jira, Confluence, Bitbucket, Git, Jenkins, Linux
    \end{itemize}
\vspace{2mm}
{\large \textbf{\begin{tcolorbox}\textsc{Internships}\end{tcolorbox}}}
\vspace{-1pt}
\href{https://github.com/PSoni8/Ken42-Internship}{\textbf{Ken42 EdTech}} (\textbf{Product Management Intern,Startup}) \hfill\hfill(\textit{Jan,2022-May,2022})
    \begin{itemize}
...
\begin{itemize}
    ...
    \item Mentor of \textbf{Script Winter of Code} \href{https://drive.google.com/file/d/1ugF3xv1k6mxt7gXyxZuuX1NnRcQKmM5F/view?usp=sharing}{\color{blue}\faIcon{link}}.\hfill\hfil(\textit{Nov,2021-March,2022})
\end{itemize}
\end{document}
